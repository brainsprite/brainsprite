...
def _update_view_template(bs_snippet, bg=None, overlay=None, cm=None):
    ...
    ----------
    bs_snippet : str
        Snippet of javascript brainsprite code.
    bg : str (either file name or base64 encoded data)
        The sprite data for the background.
    overlay : str (eithor file name or base64 encoded data)
        The sprite data for the overlay.
    cm : str (either file name or base64 encoded data)
        The image for the colormap.

    Returns
    -------
    html_view : an instance of a populated brainsprite html viewer.
    """
