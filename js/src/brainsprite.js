export default function BrainSprite(params) {
      ...
      brain.origin = typeof params.origin !== 'undefined' ? params.origin : {
        X: 0,
        Y: 0,
        Z: 0,
      };
      ...
      // The sprite image //
      //******************//
      brain.sprite = typeof params.sprite == "string" ? document.getElementById(params.sprite) : params.sprite;
      ...
      var interactive = typeof params.interactive === 'undefined' ? true : !!interactive;
      if (interactive) {
